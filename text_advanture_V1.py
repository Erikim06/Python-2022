...
# Display available path        
@when("path")
def path():
    print("\n## Available Path : ")
    if current_room.exit("north"):
        print("\t\u2191 North: %s"%current_room.exit("north").name)
    if current_room.exit("south"):
        print("\t\u2193 South: %s"%current_room.exit("south").name)
    if current_room.exit("west"):
        print("\t\u2190 West : %s"%current_room.exit("west").name)
    if current_room.exit("east"):
        print("\t\u2192 East : %s"%current_room.exit("east").name)
